...
import com.muheng.photoviewer.PhotoViewerApp
...
open class ToolbarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adId = (application as PhotoViewerApp).getJniAdMob().getTestAdId()
        val adView = (application as PhotoViewerApp).createAdView(adId)//resources.getString(R.string.test_ad_unit_id)
        addAdView(adView)
    }
